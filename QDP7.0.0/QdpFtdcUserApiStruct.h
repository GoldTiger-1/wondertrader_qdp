...
{
	///投资者编号
	TQdpFtdcNumberType	InvestorIDNum;
	///合约编号
	TQdpFtdcMinNumberType	InstrumentIDNum;
	///用户本地报单号
	TQdpFtdcUserOrderLocalIDType	UserOrderLocalID;
	///用户自定义域
	TQdpFtdcNumberType	UserCustom;
	///价格
	TQdpFtdcPriceType	LimitPrice;
	///止损价
	TQdpFtdcMinPriceType	StopPrice;
	///数量
	TQdpFtdcMinVolumeType	Volume;
	///最小成交量
	TQdpFtdcMinVolumeType	MinVolume;
	///营业部代码
...
///输入报单
struct CQdpFtdcSpInputOrderField
{
	///投资者编号
	TQdpFtdcNumberType	InvestorIDNum;
	///合约编号
	...
	TQdpFtdcBusinessTypeType	BusinessType;
	///撤单组号
	TQdpFtdcNumberType	ActionGrp;
	///对冲合约编号
	TQdpFtdcMinNumberType	HdgInstrumentIDNum;
	///买卖方向
	TQdpFtdcDirectionType	HdgDirection;
	///开平标志
	TQdpFtdcOffsetFlagType	HdgOffsetFlag;
	///价格
	TQdpFtdcPriceType	HdgLimitPrice;
	///数量
	TQdpFtdcMinVolumeType	HdgVolume;
};

///输入报单
struct CQdpFtdcRspInputOrderField
{
	///投资者编号
	TQdpFtdcNumberType	InvestorIDNum;
	///合约编号
...
struct CQdpFtdcInputQuoteField
{
	...
	///卖数量
	TQdpFtdcMinVolumeType	AskVolume;
	///卖开平标志
	...
	///买数量
	TQdpFtdcMinVolumeType	BidVolume;
	///买开平标志
...
///报价录入
struct CQdpFtdcRspInputQuoteField
{
	///投资者编号
	TQdpFtdcNumberType	InvestorIDNum;
	///合约编号
...
struct CQdpFtdcTradeField
{
	...
	///成交数量
	TQdpFtdcMinVolumeType	TradeVolume;
	///成交时间
